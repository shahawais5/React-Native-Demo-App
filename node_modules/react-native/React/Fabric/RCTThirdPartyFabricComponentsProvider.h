...
Class<RCTComponentViewProtocol> RNCViewPagerCls(void) __attribute__((used)); // 1
#endif

#if !TARGET_OS_OSX && !TARGET_OS_TV
Class<RCTComponentViewProtocol> LEGACY_RNCViewPagerCls(void) __attribute__((used)); // 2
#endif


#if !TARGET_OS_OSX
Class<RCTComponentViewProtocol> RNCSafeAreaProviderCls(void) __attribute__((used)); // 4
Class<RCTComponentViewProtocol> RNCSafeAreaViewCls(void) __attribute__((used)); // 4
#endif
...
Class<RCTComponentViewProtocol> RNCWebViewCls(void) __attribute__((used)); // 7
#endif
