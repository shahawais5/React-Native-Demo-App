...
Class<RCTComponentViewProtocol> RNCViewPagerCls(void) __attribute__((used)); // 2
#endif

#if !TARGET_OS_OSX && !TARGET_OS_TV
Class<RCTComponentViewProtocol> LEGACY_RNCViewPagerCls(void) __attribute__((used)); // 3
#endif
...
Class<RCTComponentViewProtocol> RNCWebViewCls(void) __attribute__((used)); // 8
#endif
